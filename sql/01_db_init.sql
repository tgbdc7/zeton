...
(
    ...
    FOREIGN KEY (family_member) REFERENCES users (id)
);
...
(
    ...
    last_exercise_id        integer default 0,
...
begin
    INSERT INTO points_history (child_id, points_change, id_changing_user,
                                points_name, change_timestamp)
    VALUES (new.child_id, new.points - old.points, new.last_insert_id,
            new.last_exercise_id, CURRENT_TIMESTAMP);
END;
